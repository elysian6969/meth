...
#[inline]
#[must_use]
pub const fn sub<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
where
    T: ~const Element,
    ...
    [(); Lanes::<T, N>::LANES]:,
{
    #[inline]
    #[must_use]
    const fn scalar_sub<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
    where
        T: ~const Element,
        T: ~const Sub<Output = T>,
        Lanes<T, N>: LaneCount,
    ...
    #[inline]
    #[must_use]
    fn simd_sub<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
    where
        T: Element,
        T: Sub<Output = T>,
        Lanes<T, N>: LaneCount,
