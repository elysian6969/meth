...
#[inline]
#[must_use]
pub const fn mul<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
where
    T: ~const Element,
    ...
    [(); Lanes::<T, N>::LANES]:,
{
    #[inline]
    #[must_use]
    const fn scalar_mul<T, const N: usize>(mut a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
    where
        T: ~const Element,
        T: ~const Mul<Output = T>,
        Lanes<T, N>: LaneCount,
    ...
    #[inline]
    #[must_use]
    fn simd_mul<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
    where
        T: Element,
        T: Mul<Output = T>,
        Lanes<T, N>: LaneCount,
