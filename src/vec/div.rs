...
#[inline]
#[must_use]
pub const fn div<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
where
    T: ~const Element,
    ...
    [(); Lanes::<T, N>::LANES]:,
{
    #[inline]
    #[must_use]
    const fn scalar_div<T, const N: usize>(mut a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
    where
        T: ~const Element,
        T: ~const Div<Output = T>,
        Lanes<T, N>: LaneCount,
    ...
    #[inline]
    #[must_use]
    fn simd_div<T, const N: usize>(a: Vec<T, N>, b: Vec<T, N>) -> Vec<T, N>
    where
        T: Element,
        T: Div<Output = T>,
        Lanes<T, N>: LaneCount,
